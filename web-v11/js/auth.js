...
(function (global) {
  ...
  // La sesión se persiste en localStorage (no sessionStorage): así sobrevive al CERRAR la App,
  // y al reabrir dentro de la vida del token (~1 h) se reanuda sin pedir login de nuevo.
  function guardar() {
