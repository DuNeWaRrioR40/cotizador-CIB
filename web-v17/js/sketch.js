...
(function (global) {
  ...
  function elementosSketch(sk, t) {
    ...
    (sk.cintas || []).forEach((c) => {
      ...
      // v17-106: SIN línea central de costura en el plano — con la banda rellena era ruido que
      // chocaba con los Ω. La costura se lee en la barra de detalle (ahí sí queda).
